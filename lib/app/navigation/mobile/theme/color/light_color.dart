...
class AppColor {
  ...
  static const Color piecesBackTwo = Color(0xFF383838);
  static const Color piecesBlue = Color(0xFF12CDD9);
  static const Color piecesGrey = Color(0xFF292929);
  static const Color piecesBlackGrey = Color(0xFF222222);
}
